...
export default function Footer () {
    return (
        <div className="text-center">
            ...
            <span className="block text-sm text-center text-gray-500">© 2024 Residence Navigator Center | All Rights Reserved.
            </span>
            <ul className="flex justify-center mb-5 mt-5 space-x-5">
                <li>
